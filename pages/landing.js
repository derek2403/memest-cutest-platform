...
export default function Landing() {
  ...
  const handleStartClick = (e) => {
    ...
    // Navigate to index.js after animation completes
    setTimeout(() => {
    ...
    <div className="landing-container">
        ...
        <div className="container">
          <div className="content">
            ...
            <div className="buttonContainer">
              <Link href="/login">
                <button className="loginButton" onClick={handleStartClick}>Start</button>
              </Link>
            </div>
          </div>
        </div>
      ...
      <style jsx>{`
        ...
        .loginButton {
          ...
          background: linear-gradient(135deg, #8a56ac 0%, #6e44a8 100%);
          color: white;
          border: none;
          padding: 0.9rem 3rem;
          font-size: 1.3rem;
          ...
          box-shadow: 0 4px 15px rgba(138, 86, 172, 0.4);
        ...
        .loginButton:hover {
          ...
          box-shadow: 0 7px 20px rgba(138, 86, 172, 0.6);
          background: linear-gradient(135deg, #9b67bd 0%, #7e54b8 100%);
        }
